...
//通讯录部门选择
function SelectDeptContacts(MODULE_ID,TO_ID,TO_NAME)
{
    URL="/general/contacts/manage/include/txl_select/?MODULE_ID="+MODULE_ID+"&TO_ID="+TO_ID+"&TO_NAME="+TO_NAME;
    loc_y=loc_x=200;
    if(is_ie)
    {
        loc_x=document.body.scrollLeft+event.clientX-100;
...
//清空input框中的部门名称和隐藏表单中的部门id
function ClearDeptContacts(){
    document.getElementsByName("TO_NAME")[0].value="";
    document.getElementsByName("TO_ID")[0].value="";
}