(function(gmu, $) {
    ...
    gmu.define(
        "Alist",
        {
            ...
            template: {
                item:
                    '<li class="ui-border-t list-item-inserting" data-id="<%=id%>"><%=text></li>',
                ...
                wrap:
                    '<div class="ui-refresh"><div class="ui-refresh-up"></div><ul class="data-list ui-list ui-border-tb"></ul><div class="ui-refresh-down"></div></div>'
            },
            ...
            _ajax: function(dir, type) {
                ...
                $.ajax({
                    ...
                    success: function(vdata, status, xhr) {
                        if (vdata.status) {
                            var data = vdata.data;
                            isReimbursement = vdata.isReimbursement;
                            ...
                            me.param = param;
                            $.isFunction(opts.dataFix) &&
                                (data = opts.dataFix(data));
                            var count = 0;
                            if (data) {
