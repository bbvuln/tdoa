 ...
 */ (function(window, doc) {
    var m = Math,
        ...
        D_CLICK_EV = function(e){
          var nodeName = e.target.nodeName;
          if(!e._fake && !/(INPUT|TEXTAREA|SELECT)/.test(nodeName)){
            e.stopPropagation();
          } 
        },
        // fix trigger clickEvent twice in Android 4.1+ by jx @2013/3/4
        ...
        iScroll = function(el, options) {
            ...
            if(that.options.handleClick){
              that.wrapper.addEventListener('click', D_CLICK_EV, true);
            }
            // fix trigger clickEvent twice in Android 4.1+ by jx @2013/3/4
    ...
    iScroll.prototype = {
        ...
        destroy: function() {
			...
			if(that.options.handleClick){
				that.wrapper.removeEventListener('click', D_CLICK_EV, true);
			}			
			// fix trigger clickEvent twice in Android 4.1+ by jx @2013/3/4
