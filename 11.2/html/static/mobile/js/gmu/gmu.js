 ...
 * @grammar $('selecotr').iScroll([options])  ?6?0 zepto实例
...
(function( gmu, $, undefined ) {
    ...
    gmu.define( 'Refresh', {
        ...
        _createBtn: function (dir) {
            if(dir == 'up'){
                this._options['$' + dir + 'Elem'].html('<span class="ui-refresh-icon"></span><span class="ui-refresh-label">'+td_lang.pda.msg_4 || "下拉刷新"+'</span>');
            }else{
    ...
    gmu.Refresh.register( 'iOS5', {
        ...
        _changeStyle: function (dir, state) {
            ...
            switch (state) {
                ...
                case 'beforeload':
                    if(dir == 'up'){
                        refreshInfo['$label'].html(td_lang.pda.msg_5 || '松开立即加载');
                    }else{
