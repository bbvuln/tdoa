define('CTextField', function(require, exports, module) {
    var $ = window.jQuery || window.Zepto;
    var Base = require('base');
    var CTextField = Base.extend({
        initialize: function(config) {
            CTextField.superclass.initialize.call(this, config);
            this._config = config;
        ...
        _render: function() {
            ...
            try {
                jQuery("#f-complex-input-tmpl").tmpl(configs).appendTo(wrapperId);
            } catch (error) {
                console.log(error);
            }
        },
    ...
    exports.CTextField = window.CTextField = CTextField;
});
