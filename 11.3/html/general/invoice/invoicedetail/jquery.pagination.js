        ...
        this.filling = function(index) {
            ...
            switch (opts.mode) {
                ...
                case "unfixed":
                    ...
                    var start =
                        current - opts.count <= 1 ? 1 : current - opts.count;
                    var end =
            ...
            html += opts.jump
                ? '<a href="javascript:;" class="' +
                  ...
                  '">' +
                  opts.jumpBtn +
                  '</a><input type="text" class="' +
                  opts.jumpIptCls +
                  '"><span class="jump-btn">页</span>'
                : "";
            html +=
                '<div class="jump-btn">共' + opts.totalData + "条数据</div>";
            $obj.empty().html(html);
        };
            ...
            $obj.off().on("click", "a", function() {
                if ($(this).hasClass(opts.nextCls)) {
                    if ($obj.find("." + opts.activeCls).text() >= pageCount) {
                        ...
                        index =
                            parseInt($obj.find("." + opts.activeCls).text()) +
                            1;
                    }
