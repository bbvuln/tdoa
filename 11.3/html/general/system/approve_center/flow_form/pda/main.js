...
(function() {
    ...
    $(function() {
        ...
        if (formId !== '') {
            ...
            //取对应form_id的数据
            $.get('/general/system/approve_center/flow_form/pda/formdata.php',{FORM_ID:formId},
            // $.get('data.json',
            function(data) {
        ...
        {
            //取对应form_id的数据
            $.get('/general/system/approve_center/flow_form/pda/formdata.php',{version_form_id:versionFormId},
                // $.get('data.json',
                function(data) {
                    //console.info('getdata',data);
                    typeof data === 'string' ? data = JSON.parse(data) : data = data
