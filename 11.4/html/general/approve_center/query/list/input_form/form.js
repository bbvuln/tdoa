...
function tb_addnew(lv_tb_id,read_only,row_value,is_del,new_width)
{
    ...
    {
        mynewcell.innerHTML = "<input type=button style='background-color:#3aabf9 ;' value=\""+td_lang.global.select +"\" onclick=list_data_picker(this,'"+data_table+"','"+data_field+"','"+data_fld_name+"','"+dataQuery+"')>" + mynewcell.innerHTML;//选择
    }
