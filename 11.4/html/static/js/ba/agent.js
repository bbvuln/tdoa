window._td_ba && window._td_ba.server ||
function(t) {
    function r(t) {
        switch (typeof t) {
        case "object":
            ...
            if (t instanceof Array) {
                for (var e = "[",
                n = 0; n < t.length; n++) e += (n > 0 ? ",": "") + r(t[n]);
                return e + "]"
            }
            var e = "{",
            n = 0;
            for (var a in t) if ("function" != typeof t[a]) {
                var o = r(t[a]);
                e += (n > 0 ? ",": "") + r(a) + ":" + o,
                n++
            }
        ...
        function(e) {
            ...
            function(t) {
                return function() {
                    ...
                    a = n[0];
                    return "function" == typeof a && (e = i(a, r, !0)),
                    e && (n[0] = e),
                    t.apply ? t.apply(this, n) : Function.prototype.apply.apply(t, [t, n])
                }
            })
        })
    }
    ...
    function c(t) {
        P && N.wrap(!1, P.prototype, "addEventListener",
        function(r) {
            return function() {
                var e, n = N.args.apply(this, arguments),
                a = n[1];
                return "function" == typeof a && (e = i(a, t, !0)),
                e && (n[1] = e),
                r.apply(this, n)
            }
        }),
    ...
    function g(t) {
        if (t[6]) {
            ...
            if (e && "string" == typeof e && r) {
                ...
                var n = C.exec(e[0]);
                n || (n = C.exec(e[1])),
                n && n[1] != r && (t[4] = n[1] || r, t[2] = n[2] || t[2], t[3] = n[3] || t[3])
            }
        }
    }
    function _(t, r, e, n) {
        ...
        return function() {
            function e(t) {
                ...
                if (a) {
                    ...
                    if (a.readyState = p.readyState, a.cb_time = d, r = [a.method + " " + a.url, a.s > 0 ? a.end - a.start: 0, d, a.s, a.s > 0 ? 0 : t, a.res, a.req], a.r && (e = i(p), e && (e = e.xData) && (r.push(e.id), r.push(e.action), r.push(e.time && e.time.duration), r.push(e.time && e.time.qu))), D.aa.push(r), D.server.custom_urls && D.server.custom_urls.length && !U.ct) {
                        ...
                        for (var s = 0; s < D.pattern.length; s++) if (a.url.match(D.pattern[s])) {
                            U.ct = a.end + d;
                            break
                        }
                    }
            ...
            function i(r) {
                ...
                if (r.getResponseHeader) {
                    var n = N.parseJSON(r.getResponseHeader("X-Tongda-Tx-Data"));
                    n && n.r && r._td_ba && n.r + "" == r._td_ba.r + "" && (e = {
                        name: r._td_ba.url,
                        xData: n
                    },
                    $ && t._td_ba.c_ra.push(e))
                }
                return e
            }
            function c(t) {
                return function() {
                    var r, e;
                    4 == p.readyState && p._td_ba && (p._td_ba.end = r = n(), p._td_ba.readyState = 4);
                    try {
                        E && s(E),
            ...
            if (!this._td_wrap) {
                this._td_ba.start = n(),
                this._td_ba.req = arguments[0] ? T(arguments[0]) : 0;
                var p = this,
                d = 0,
                h = N.wrap(!1, this, "onreadystatechange", c);
                h || N.sh(this, "readystatechange", a, !1),
                l(this, ["error", "progress", "abort", "load", "loadstart", "loadend", "timeout"]),
            ...
            var m = function() {
                function t(t) {
                    ...
                    return e && (r.protocol = e[1] ? e[1] + ":": "http:", r.hostname = e[3], r.port = e[4] || ""),
                    r
                }
                return function(r) {
                    var e = location;
                    if (r = N.trim(r)) {
                        ...
                        return a && (a = n.port === e.port ? !0 : !e.port && ("http:" === e.protocol && "80" === n.port || "https:" === e.protocol && "443" === n.port)),
                        a
                    }
                    return ! 1
                }
            ...
            try {
                var v = D.server;
                v && v.id && this._td_ba && m(this._td_ba.url) && (this._td_ba.r = (new Date).getTime() % 1e8, this.setRequestHeader && this.setRequestHeader("X-Tongda-Id", v.id + ";r=" + this._td_ba.r))
            } catch(g) {}
            try {
    ...
    N = {
        wrap: function(t, r, e, n, a) {
            ...
            if (!o && !t) return ! 1;
            if (o && o._td_wrap) return ! 1;
            try {
                r[e] = n(o, a)
            } catch(i) {
                return ! 1
            }
            return r[e]._td_wrap = [o],
            !0
        },
        unwrap: function(t, r) {
            try {
        ...
        mkurl: function(r, a) {
            ...
            a = a.match(/.php/ig) ? a : (a + '.php');
            if (i = r + "/" + a + "?v=0.0.1&ref=" + e(x.URL) + "&guid=" + D.server.guid + "&pvid=" + F, "pf" !== a && D && (D.agent = D.agent || t._td_ba.agent, D.agent && D.agent.n && (i += "&n=" + e(D.agent.n))), o.length > 2) {
                var s = o[2];
                for (var u in s) i += "&" + u + "=" + s[u]
            }
            return A.host && (i += "&cshst=" + e(A.host)),
        ...
        GET: function(t, r) {
            ...
            function() { ("loaded" == n.readyState || 4 == n.readyState) && e("loaded")
            },
            !1),
            this.sh(n, "load",
            function() {
        ...
        fpt: function(t, r, e) {
            ...
            i.submit(),
            o.onreadystatechange = function() { ("complete" === o.readyState || 4 === o.readyState) && (e(null, o.innerHTML), x.body.removeChild(a))
            },
            !0
        },
        POST: function(r, e, n, a) {
            ...
            var i;
            if (t.XDomainRequest) return i = new XDomainRequest,
            i.open("POST", r),
            i.onload = function() {
            ...
            !1),
            this.wrap(!0, i, "onerror",
            function(t) {
                return function() {
                    return a && a("post error", i.responseText),
                    !0
                }
            }),
            i.send(e),
            ...
            i.onerror && this.wrap(!0, i, "onerror",
            function(t) {
                return function() {
                    return a("post error", i.responseText),
                    "function" == typeof t ? t.apply(this, arguments) : !0
                }
            });
            try {
                i.open("POST", r, !0)
    ...
    if (D.server && !(D.server.sr && Math.random() >= D.server.sr)) {
        ...
        for (var U = D.metric = {
            ...
            send: function() {
                function r() {
                    ...
                    if ($ && $.timing) {
                        ...
                        a.secureConnectionStart && (n.sl = r("secureConnectionStart"))
                    } else n = {
                        t: i,
                        os: D.end_time - i,
                        ls: D.load_time - i
                    };
                    n.je = U.errors.length,
                    U.ct && (n.ct = U.ct - i),
                    U.touch && (n.fi = U.touch - i);
                    var h = D.agent || t._td_ba && t._td_ba.agent;
                    return h && (n.id = e(h.id), n.a = h.a, n.q = h.q, n.tid = e(h.tid), n.n = e(h.n)),
                ...
                function o(t) {
                    ...
                    if (n && n.getEntriesByType) {
                        ...
                        u && (s = s.concat(u), n.webkitClearResourceTimings && n.webkitClearResourceTimings(), n.clearResourceTimings && n.clearResourceTimings()),
                        o.res = [];
                        for (var c = 0; c < s.length; c++) {
                            ...
                            p = a(f.name);
                            p && (l.aid = p.id, l.atd = p.trId, l.an = p.action, l.aq = p.time && p.time.qu, l.as = p.time && p.time.duration),
                            o.res.push(l)
                        }
                        if (U.errors.length) {
                            o.err = [];
                ...
                try {
                    pf = r(),
                    s = o(pf.ls > 0 ? pf.ls: D.load_time - i)
                } catch(u) {}
                s = s ? N.stringify(s) : "";
                var c = N.mkurl(D.server.beacon, "pf", pf);
                B = n(),
                0 != s.length && N.POST(c, s, {},
                l("POST")) || N.GET(c);
                var f = N.bind(p, this);
                return f(),
                setInterval(f, 1e4),
            ...
            sa: function(t) { (this.ready() || t) && (t || (t = !this._last_send || n() - this._last_send > D.snd_du() || D.aa.length >= D.cc()), D.aa.length > 0 && t && (this._last_send = n(), N.POST(N.mkurl(D.server.beacon, "xhr"), N.stringify({
                    xhr: D.aa
                }), {},
                l("POST")), D.aa = []))
            },
        ...
        X = null, j = {},
        z = [["load", m], ["beforeunload", y], ["pagehide", y], ["unload", y]], J = 0; J < z.length; J++) N.sh(t, z[J][0], z[J][1], !1);
        t.addEventListener ? N.sh(t, "error", w, !1) : t.onerror = function(t, r, e, n, a) {
            var o = [t, e, n, r == x.URL ? "#": r];
            if (a) {
                var i = _(t, e, n, a.moduleName);
                o = o.concat([1, a.stack, a.moduleName, j[i] ? 0 : 1]),
                j[i] = !0
            }
            g(o),
            U.errors.push(o)
        };
        for (var W = [["scroll", v], ["keypress", v], ["click", v], ["DOMContentLoaded", d], ["readystatechange", h]], J = 0; J < W.length; J++) N.sh(x, W[J][0], W[J][1], !1);
        if (N.wrap(!1, t, "requestAnimationFrame",
        function(r) {
            return function() {
