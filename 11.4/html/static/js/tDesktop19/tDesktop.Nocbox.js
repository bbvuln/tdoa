define('tDesktop19/tDesktop.Nocbox',function(require, exports, module){
    var $ = window.jQuery;
    var Nocbox = {
        init: function(c){
        ...
        bindEvent: function(){
            var self = this;
            self.tDesktop19.EventManager.on('loadNoc:load',function() {
                self.loadNoc();
            });

            self.tDesktop19.EventManager.on('notify:read',function(item) {
            ...
            self.tDesktop19.EventManager.on('nocbox:markAll',function(ids,msgIdStr) {
                self.removeNoc($('.noc_item_cancel'),ids,0,msgIdStr);
            })
            //click to read item detail
            $('#new_noc_list_wrapper').delegate('.noc_item_data li', 'click', function(){
        ...
        formatNoc: function(data){
	        ...
	        $.each(data,function(key, item){ 
                ...
                self.tDesktop19.EventManager.trigger('message:create', item);  
