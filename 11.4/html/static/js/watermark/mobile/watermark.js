(function (root,factory) {
    ...
    var loadMark = function(settings) {
		...
		var page_width = document.body.clientWidth - defaultSettings.watermark_width/2;
        //获取页面最大长度
		...
		var page_height = Math.max(document.body.clientHeight,document.documentElement.clientHeight)-defaultSettings.watermark_height/2;
        ...
        if(!otdiv){
			...
			otdiv.className = "td_wm_container"
        ...
        if (defaultSettings.watermark_cols == 0 || (parseInt(defaultSettings.watermark_x + defaultSettings.watermark_width *defaultSettings.watermark_cols + defaultSettings.watermark_x_space * (defaultSettings.watermark_cols - 1)) > page_width)) {
            defaultSettings.watermark_cols = parseInt((page_width - defaultSettings.watermark_x + page_offsetLeft) / (defaultSettings.watermark_width + defaultSettings.watermark_x_space))+1;
		...
		//和移动端统一算法
		var strongW = parseInt(page_width/defaultSettings.watermark_width);
		var strongH = parseInt(page_height/defaultSettings.watermark_height);;
		for (var i=0; i<(strongH*strongW); i++) {
			defaultSettings.watermark_x_space = (page_width - (defaultSettings.watermark_width * strongW)) / (strongW + 1)-10;//水平间距
			defaultSettings.watermark_y_space = (page_height -(defaultSettings.watermark_height * strongH)) / (strongH + 1);//垂直间距
		}
