...
function trigger_callback(type, args){
    ...
    if(typeof parent_window.invoice_select_callbacks == 'object' && (typeof parent_window.invoice_select_callbacks[type] == 'function' || typeof parent_window.invoice_select_callbacks[type] == 'object')){
        try
        {

           parent_window.invoice_select_callbacks[type](args);
