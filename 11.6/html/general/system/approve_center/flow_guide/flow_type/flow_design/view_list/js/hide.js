...
jQuery(document).on("dblclick", "tr[class^='r_alternative_step']", function(){
	...
	var countersign_1 = $('#countersign_item').find('input[id="COUNTER_'+uid_+'_1"]');//会签输入区
	var countersign_2 = $('#countersign_item').find('input[id="COUNTER_'+uid_+'_2"]');//会签盖章
	var countersign_3 = $('#countersign_item').find('input[id="OP_USER_'+uid_+'_3"]');//主办必填
	var countersign_4 = $('#countersign_item').find('input[id="USER_'+uid_+'_4"]');//经办必填
