 ...
 * version: 1.7.3
 * number:002
 * 2019.08.16版本跟随 北京通达信科科技有限公司20190821 产品发送
 */
"use strict";
...
var ntkoBrowser = {
    ...
    openWindow:function( strURL,IsShowOnExtendMonitor,ProductCaption, ntkoBrowserProductKey, ntkoBrowserNoExpireKey, ntkoBrowserOptions )
    {
        ...
        if(ntkobr){
            ...
            ntkoWinOpen=window.open(strURL,ntkowin,"height="+ntkowidth+", width="+ntkowidth+", titlebar=no,toolbar =no, menubar=no, scrollbars=no, resizable=yes, location=no, status=no");
            ntkoWinOpen.focus();
        }
    },
    NtkoWShell:function(){
