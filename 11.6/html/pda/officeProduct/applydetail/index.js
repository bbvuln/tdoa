                ...
                success: function(res) {
                    ...
                    if (status) {
                        ...
                        if (data) {
                            ...
                            if (state == 3) {
                                btns =
                                    '<div><div class="cancel clearfix">取消</div><div class="save">编辑</div></div>';
                            }
                            if (state === 2) {
                                cancelBtnDom =
                        ...
                        if (state === 3 || state === 2) {
                            dialogDom =
                                '<div class="ui-dialog"><div class="ui-dialog-cnt"><div class="ui-dialog-bd"><h3>确定取消申领吗?</h3></div><div class="ui-dialog-ft"><button type="button" data-role="button" class="btn-cancle">取消</button><button type="button" data-role="button" class="btn-submit">确定</button></div></div></div>';
                            detailDom += dialogDom;
                        }
                        el.append(detailDom);
                        if (dialogDom) {
