        ...
        render: function() {
            ...
            for(i=0;i<42;i++) {
                ...
                if(sD>-1 && sD<this.length) { //日期内
                    ...
                    if(this[sD].solarTerms=='清明') s = '清明节'.fontcolor('red');
                    if(this[sD].solarTerms=='芒种') s = '芒种'.fontcolor('red');
                    if(this[sD].solarTerms=='夏至') s = '夏至'.fontcolor('red');
                    if(this[sD].solarTerms=='冬至') s = '冬至'.fontcolor('red');
