define('tDesktop19/tDesktop.Tabs', function(require, exports, module){
    var $ = window.jQuery;
    var pulser = require('tDesktop19/tDesktop.Pulse');
	window.id2subtab = {};
    var Tabs = {
        init: function(){
            this.initTabs();
            ...
            $('#tabs_container').tabs({
				...
				callbacks: {
					selected: function(e){
						if(id2subtab[e.id]){
							jQuery("#funcbar").show();
							jQuery("#center").css("top","86px");
						}else{
							jQuery("#funcbar").hide();
							jQuery("#center").css("top","46px");
						}
					}
				}
            });
        ...
        createTab: function(id, name, code, open_window){
            ...
            jQuery.ajax({
                ...
                success: function(data){
					...
					jQuery("#funcbar").css("display","block");
					jQuery("#center").css("top","86px");
                },
