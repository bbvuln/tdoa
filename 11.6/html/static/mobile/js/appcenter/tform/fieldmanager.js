define('FieldManager', ['FieldLoader', "base"], function (require, exports, module) {
    ...
    var FieldManager = Base.extend({
        ...
        fetchApplylist: function () {//获取发票数据
            var self = this;
            var formInfo = store.formInfo,
                run_id = formInfo.run_id,
                flow_id = formInfo.flow_id,
        ...
        selectInvoiceBack: function () {//清除数据
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.status == 'ok') {
                        ...
                        // InvoiceType,//票据类型 01专票 04普票 10电子票 21火车票 22飞机票 23出租车票
...
//                                }))
      ...
      success : function(response){
        ...
        pageinit: function (data, cfg) {//解析数据
            var self = this;
