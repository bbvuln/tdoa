// "/static/js/jquery-1.5.1/jquery.min.js","/static/js/jquery-1.5.1/jquery-ui.custom.min.js","/static/js/jquery-1.5.1/jquery.ui.autocomplete.min.js","/static/js/jquery-1.5.1/tooltip/jquery.tooltip.min.js","/static/js/jquery-1.5.1/jsrender/jsrender.gbk.min.js","/static/js/dialog.js","/static/js/mouse_mon.js","/static/js/tdPass.js","/general/workflow/list/input_form/js/work_handle.js","/general/workflow/list/input_form/form.js","/static/modules/workflow/js/runtime.js","/static/js/arale/base/1.1.1/base.js","/static/js/arale/class/1.1.0/class.js","/static/js/arale/events/1.1.0/events.js"
...
function ShowOutPage(id)//yzx   弹出打印窗口的签章显示
{
    $(id).style.display = 'block';
}
function HideOutPage(id)//yzx   弹出打印窗口的签章页面隐藏
{
    $(id).style.display = 'none';
}
...
/* "/general/workflow/list/input_form/js/work_handle.js" */
...
/* "/general/workflow/list/input_form/form.js" */
var radio_count=0;
    ...
    for (i=1; i < row_length; i++)
    {
        for (j=1; j < document.getElementById(lv_tb_id).rows[i].cells.length-1; j++)
        {
            ...
            else if(coltype_array[j-1]=="textarea")
            {
            	...
            	{
            		textarea_html = cell.innerHTML+"`";
            	}
            	else
            	{
            		textarea_html = cell.firstChild.value+"`";
            	}
...
function tb_sum(lv_tb_id,sum)//合计
{
...
function calc_getval(val)
{
    ...
    var is_selectCtrl = obj[0].tagName;
    ...
    //判断是否是下拉菜单
    if(is_selectCtrl == "SELECT")
    {
        //如果是子表则取第一个“|”前的值
        if(vVal.indexOf("|") >= 0)
        {
            vVal = vVal.substr(0, vVal.indexOf("|"));
        }
    }
...
;(function(win, $){
    var tWorkflow = {
        ...
        clearFeedback: function(){
            try{
                CKEDITOR.instances["TD_HTML_EDITOR_CONTENT"].document.getBody().setHtml('');
            }catch(e){}
        }
    };
